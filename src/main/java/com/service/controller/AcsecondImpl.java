...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.CseSpringCodegen", date = "2017-11-16T02:31:47.202Z")

@RestSchema(schemaId = "acsecond")
@RequestMapping(path = "/acsecond", produces = MediaType.APPLICATION_JSON)
public class AcsecondImpl {

    @Autowired
    private AcsecondDelegate userAcsecondDelegate;
    ...
    public Integer add( @RequestParam(value = "a", required = true) Integer a, @RequestParam(value = "b", required = true) Integer b){
        ...
        return userAcsecondDelegate.add(a, b);
    }
    ...
    public String sayHei( @RequestHeader(value="name", required=true) String name){
        ...
        return userAcsecondDelegate.sayHei(name);
    }
    ...
    public String sayHello( @PathVariable("name") String name){
        ...
        return userAcsecondDelegate.sayHello(name);
    }
    ...
    public String sayHi( @RequestParam(value = "name", required = true) String name){
        ...
        return userAcsecondDelegate.sayHi(name);
    }
    ...
    public String saySomething( @RequestParam(value = "prefix", required = true) String prefix, @RequestBody Person user){
        ...
        return userAcsecondDelegate.saySomething(prefix, user);
    }
